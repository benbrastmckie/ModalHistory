...
class DefAlwaysOperator(syntactic.DefinedOperator):
    """
    This is the 'Always' operator, generally written as △.
    '△A' is defined as 'Past(A) ∧ A ∧ Future(A)'
    """
    ...
    def derived_definition(self, argument):  # type: ignore
        return [AndOperator, [AndOperator, [PastOperator, argument], argument], [FutureOperator, argument]]
